...
STATIX_QPR_VERSION   := 3
STATIX_MINOR_VERSION := 0
ifndef STATIX_BUILD_TYPE
    STATIX_BUILD_TYPE := UNOFFICIAL
endif

STATIX_VERSION := $(TARGET_PRODUCT)-$(BUILD_DATE)-$(STATIX_PLATFORM_VERSION)-$(STATIX_PLATFORM_VERSION).$(STATIX_QPR_VERSION).$(STATIX_MINOR_VERSION :=)-$(STATIX_BUILD_TYPE)
