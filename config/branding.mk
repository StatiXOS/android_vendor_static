...
## Versioning System
# Set all versions
STATIX_BASE_VERSION := v7
STATIX_AOSP_TAG_REV := r50
...
STATIX_VERSION := $(TARGET_PRODUCT)-$(BUILD_DATE)-$(STATIX_PLATFORM_VERSION)-$(STATIX_BASE_VERSION).$(STATIX_AOSP_TAG_REV)-$(STATIX_BUILD_TYPE)
